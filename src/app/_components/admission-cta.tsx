...
function CallTitle({ title }: { title: string }) {
  ...
  return (
    <h3 className="font-display font-normal">
      <span className="block text-7xl">{lead}</span>
      {tail === null ? null : <span className="block text-4xl">{tail}</span>}
    </h3>
  );
}
  ...
  return (
    <section className="field-brand gutter-x section-y" id="admission">
      <div className="mx-auto max-w-page">
        ...
        <SplitText
          as="h2"
          className="mt-8 font-display text-5xl font-normal lg:mt-12 lg:w-8/12"
        >
          {section.heading}
        </SplitText>
