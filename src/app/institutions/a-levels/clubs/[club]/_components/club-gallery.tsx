...
export function ALevelsClubGallery({ club }: { readonly club: ALevelsClub }) {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-page relative z-10">
        <SectionHeader
          description={`Photographic archive of expeditions, outreach drives, workshops, and sporting tournaments organized by the ${club.title} Club.`}
