          ...
          <div className="lg:col-span-7">
            <Reveal stagger={0.08}>
              ...
              <RevealItem className="mt-10">
                <div className="relative overflow-hidden rounded-2xl bg-[#FFAD00]/10 p-6 sm:p-8 border border-[#FFAD00]/30">
                  <Icon
              ...
              <div className="rounded-3xl border border-border bg-white p-7 sm:p-9 shadow-sm">
                ...
                <ul className="mt-6 flex flex-col gap-4">
                  {club.objectives.map((objective) => (
                    ...
                    >
                      <span className="mt-1 flex size-5 shrink-0 items-center justify-center rounded-full bg-[#BD1B21]/10 text-[#BD1B21]">
