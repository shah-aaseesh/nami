...
const programmes: BachelorsProgrammesCopy = {
  ...
  items: [
    ...
    },
    {
      ...
      summary: [
        "Environment is not only the \"surrounding\". It is the sum total of all the living and non-living entities affecting each other including humans. Environment is the ultimate resource for all living beings but with human's need/greed, the status of environment is undergoing degradation. Accordingly, the environment has become the focus of many disciplines and discourses and encompasses biology, physics, chemistry, geography, sociology, economics, management, laws, governance and policies, ethics, and philosophy. Environmental issues are now part of every career path and employment. Therefore, a holistic knowledge and understanding of different disciplines is essential. The Bachelors in Environmental Studies (BES) is designed with focus on social, economic, and ecological dimensions of environmental issues.",
        "Course Highlights: BES is a four-year (eight-semester) programme. Some of the featured courses and focus areas include Environmental Issues, Green Entrepreneurship, Conservation and Protected Areas, Environmental Pollution, Indigenous Traditional Knowledge (ITK) and Practices, Environmental Arts and Design, Nature-Based Solutions and Innovation, Environmental Tourism, Community-Based Learning, and Internships & Environmental Projects.",
      ],
