  ...
  return (
    ...
    >
      ...
      <TabsPrimitive.Indicator
        ...
        className="absolute bottom-0 left-0 h-1 w-(--active-tab-width) translate-x-(--active-tab-left) bg-accent rounded-full transition-[translate,width] duration-300 ease-out"
      />
    </TabsPrimitive.List>
  );
}
