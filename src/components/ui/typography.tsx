...
export const Display = createText(
  "h1",
  "display",
  "font-display text-7xl font-normal text-balance",
);

export const H1 = createText(
  "h1",
  "h1",
  "font-display text-6xl font-normal text-balance",
);

export const H2 = createText(
  "h2",
  "h2",
  "font-display text-5xl font-normal text-balance",
);

export const H3 = createText(
  "h3",
  "h3",
  "font-display text-4xl font-normal text-balance",
);

export const H4 = createText(
  "h4",
  "h4",
  "font-display text-3xl font-normal text-balance",
);

export const H5 = createText(
  "h5",
  "h5",
  "font-display text-2xl font-normal text-balance",
);

export const H6 = createText(
  "h6",
  "h6",
  "font-display text-xl font-normal text-balance",
);
