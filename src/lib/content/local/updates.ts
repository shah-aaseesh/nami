...
const published: readonly Update[] = [
  ...
  },
  {
    ...
    excerpt:
      "Pre-registration for the Cambridge A-Level programme is open at NAMI College.",
  ...
  {
    ...entryOf("group-notice-all-campuses"),
    kind: "news",
    category: "general",
    institution: null,
    title:
  ...
  {
    ...entryOf("group-notice-examination-results"),
    kind: "news",
    category: "results",
    institution: null,
  ...
  {
    ...entryOf("school-uniform-and-stationery-collection"),
    kind: "notice",
    category: "admissions",
    institution: "school",
  ...
  {
    ...entryOf("school-junior-sports-day"),
    kind: "event",
    category: "events",
    institution: "school",
  ...
  {
    ...entryOf("school-junior-library-reopens"),
    kind: "news",
    category: "general",
    institution: "school",
  ...
  {
    ...entryOf("school-parents-evening-scheduling"),
    kind: "notice",
  ...
  {
    ...entryOf("college-a-level-registration-window"),
    kind: "notice",
    category: "admissions",
    institution: "college",
    title: "A-Level Registration Window",
    excerpt: "A notice from the college about the A-Level registration window.",
  ...
  {
    ...entryOf("college-inter-house-quiz-final"),
    kind: "event",
    category: "events",
    institution: "college",
  ...
  {
    ...entryOf("college-a-level-intake-orientation"),
    kind: "event",
    category: "events",
    institution: "college",
  ...
  {
    ...entryOf("college-examination-session-note"),
    kind: "news",
    category: "results",
    institution: "college",
  ...
  {
    ...entryOf("institute-thesis-submission"),
    kind: "notice",
    category: "examinations",
    institution: "institute",
  ...
  {
    ...entryOf("institute-undergraduate-research-day"),
    kind: "event",
    category: "events",
    institution: "institute",
  ...
  {
    ...entryOf("institute-partnership-announcement"),
    kind: "news",
    category: "holidays",
    institution: "institute",
  ...
  {
    ...entryOf("institute-graduate-careers-fair"),
    kind: "event",
    category: "events",
    institution: "institute",
  ...
  {
    ...entryOf("college-revised-class-timetable"),
    kind: "notice",
    category: "general",
    institution: "college",
  ...
  {
    ...entryOf("institute-library-access-hours"),
    kind: "notice",
    category: "general",
    institution: "institute",
  ...
  {
    ...entryOf("press-release-nami-group-statement"),
    kind: "press-release",
    category: "general",
    institution: null,
  ...
  {
    ...entryOf("press-release-college-announcement"),
    kind: "press-release",
    category: "general",
    institution: "college",
