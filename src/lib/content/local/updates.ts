...
const published: readonly Update[] = [
  ...
  },
  {
    ...
    category: "events",
    institution: "college",
    title: "NAMI A Level Students Tour of Mustang & Muktinath",
    excerpt:
      "NAMI organized an enriching 3-night, 4-day tour for A Level students to explore the picturesque region of Mustang and visit the sacred Muktinath temple.",
  ...
  },
  {
    ...
    excerpt:
      "NAMI hosted a vibrant welcome programme on July 29, 2023, for its A Level students at Kwality Beach Resort, Mulkot, and the event was nothing short of magical.",
  ...
  },
  {
    ...
    category: "events",
    institution: null,
    title: "Eco Club's Environment Day Programme",
    excerpt:
      'NAMI Eco Club orchestrated a captivating Environment Day programme that left a lasting impact on approximately 30 participants. The event, dedicated to fostering environmental awareness, featured a thought-provoking photo exhibition and an engaging photo contest centered around the theme of "Nature."',
  ...
  },
  {
    ...
    category: "events",
    institution: null,
    title: "Plantation Programme on the Occasion of World Environment Day",
    excerpt:
      "NAMI organized a Plantation programme along with Nature Art Competition in collaboration with WCN (Wildlife Conservation Nepal) and Gokarneshwor Municipality on 5th June at NAMI premises.",
  ...
  {
    ...entryOf("school-dashain-holiday-notice-2026"),
    kind: "notice",
    category: "holidays",
    institution: "school",
    title: "Dashain Festival Holiday Notice",
    excerpt:
      "Dear Parents/Guardians,\nThis is to kindly inform you that the school will remain closed for the Dashain Festival holiday from 17th October 2026 to 25th October 2026.\nRegular classes will resume from 26th October 2026 (Monday) as per the regular school schedule.\nWe wish all our students and families a joyful and peaceful Dashain.\nRegards,\nNAMI International School",
    publishedAt: isoDate("2026-09-20"),
    happensAt: isoDate("2026-10-17"),
    venue: null,
    link: null,
    image: schoolTransport,
  },
  {
    ...entryOf("college-caie-examinations-notice-2026"),
    kind: "notice",
    category: "examinations",
    institution: "college",
    title: "CAIE Examinations Schedule & Guidelines",
    excerpt:
      "Dear Students,\nA gentle reminder that the CAIE Examinations will begin on Monday, 28 September 2026.\n• Morning Shift: Examination starts at 10:45 AM; reporting time is 10:15 AM.\n• Afternoon Shift: Examination starts at 2:45 PM; reporting time is 2:15 PM.\nExam Venue: NAMI College, Hall 3.\nPlease ensure that you arrive at the college on time with your SOE and ID card, which are mandatory to sit for the examination.\nThank you.\nNAMI College NP743",
    publishedAt: isoDate("2026-09-20"),
    happensAt: isoDate("2026-09-28"),
    venue: "NAMI College, Hall 3",
    link: null,
    image: readingHall,
  },
];
